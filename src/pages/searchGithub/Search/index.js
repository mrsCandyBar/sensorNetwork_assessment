    ...
    <React.Fragment>
      <div className='columns is-vcentered is-mobile'>
        <div className='column is-one-quarter'>
          <svg aria-hidden="true" viewBox="0 0 16 16" version="1.1" width="100%" height="100%" data-view-component="true" className="octicon octicon-mark-github v-align-middle">
      ...
      <form className="columns is-gapless border" onSubmit={submitAction}>
        ...
        <div className="column breakout">
          <button className="button is-fullwidth is-maxheight is-black">
